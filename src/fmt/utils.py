...
def load_image(fname):
    ...
    if format == 'pkl':
        ...
        raise FileExtensionError(format)

def draw_plan(world, plan, map_idx, pidx, hw, bgr=(255,0,0), thickness=1):
    img = np.copy(world)
    ...
    cv2.imwrite(f'output/fmt_result_{map_idx}_{pidx}_hw_{hw}.png', img)
